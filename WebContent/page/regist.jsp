...
function checkUsername() {
	...
	/*	error: function(XMLHttpRequest, textStatus, errorThrown){  
        alert(XMLHttpRequest.status); 返回4正常
        alert(XMLHttpRequest.readyState);返回200正常
        alert(textStatus);
        }
	*/	
	});
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" name="name" class="text"
										maxlength="200" /> <span><s:fielderror fieldName="name" />
									</span></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" name="addr" class="text"
										maxlength="200" /> <span><s:fielderror fieldName="addr" />
									</span></td>
								</tr>
								<tr>
